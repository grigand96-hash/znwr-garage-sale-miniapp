...
// Очки за уровни растут бесконечно, но с гармоническим затуханием (каждый
// следующий уровень даёт всё меньше). Это не игровой потолок, а предохранитель
// от фейкового счёта-гиганта (недостижим для человека) — держим синхронно с
// сервером (MAX_SCORE_MULTIPLIER), иначе локальное место разойдётся с рейтингом.
const maxScoreMultiplier = 1000;
...
const onboardingScreens = [
  ...
  },
  {
    ...
    lines: [
      ...
      "ПОБЕДИТЕЛЯ ВЫБЕРЕТ СЛУЧАЙНЫЙ РОЗЫГРЫШ",
      "ЧЕМ БОЛЬШЕ ОЧКОВ, ТЕМ ВЫШЕ ШАНС ВЫИГРАТЬ",
  ...
  },
  {
    ...
    lines: [
      ...
      "ПОБЕДИТЕЛЯ ВЫБЕРЕТ СЛУЧАЙНЫЙ РОЗЫГРЫШ",
      "БОЛЬШЕ ОЧКОВ = БОЛЬШЕ ШАНСОВ ВЫИГРАТЬ",
